...
export const Slice = ({ contact }) => {
  ...
  return (
    <>
      <ConfirmDelete open={openConfirm} setOpen={setOpenConfirm} onConfirm={() => {
      ...
      >
        ...
        <div className="flex justify-end col-span-2 gap-x-1">
          ...
          >
            ...
            <svg height="196" viewBox="0 0 169 196" className="h-6 w-6 stroke-indigo-600 dark:stroke-indigo-100"
              xmlns="http://www.w3.org/2000/svg"
            >
              <g
                fill="none">
