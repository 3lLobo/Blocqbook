  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'logo-black': 'url("/blocqBookLogo/icon/blocqbookTextTransparentBanner.png")',
        'logo-indigo': 'url("/blocqBookLogo/icon/blocqbookTextTransparentBannerLight.png")',
        'catch-phrase': 'url("/blocqBookLogo/text/blocqbookTextonlyTrans.png")',
      },
    },
  },
  plugins: [
